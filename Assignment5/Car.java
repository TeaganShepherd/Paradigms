...
public class Car  extends Sprite{
    ...
    public Car(String name){
        ...
        myTank = new GasTank(0);
        setX(0);
        setY(0);

    }
    public Car(String des, int maxFuel, Engine engine, String jpg){
        super(jpg);
    ...
    public String getDescription(){
        return description + "(" + myEngine.getDescription() + ")," + myTank.getTank() + ",location: (" + getX() + ","+ getY()+ ")";
    }
